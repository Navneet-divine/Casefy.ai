    ...
    <LayoutWrapper>
      <div className="p-4 sm:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">Manage your legal cases and documents</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-muted-foreground text-sm mb-1">Chat Messages</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-12">
          ...
          <div className="order-1 lg:order-none">
            <div className="mb-4">
              <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4">Cases</h2>
              <CaseForm />
            </div>
            <div className="mt-6">
              <CaseList />
              ...
              {selectedCase && (
                <Card className="p-4 mb-4">
                  <div className="space-y-2">
                    ...
                    <p className="font-semibold text-foreground text-sm sm:text-base">{selectedCase.caseNumber}</p>
                    <p className="text-sm text-muted-foreground mt-3">Description</p>
                    <p className="text-foreground text-sm sm:text-base">{selectedCase.description}</p>
                    <div className="flex flex-wrap gap-2 mt-4">
                      <Badge variant="outline" className="text-xs sm:text-sm">{selectedCase.files.length} files</Badge>
